...
export const makeRestUtils = (rest: Rest) => ({
  ...
  fetchRoles: (...args: Parameters<typeof Routes.guildRoles>) => rest.get<RESTGetAPIGuildRolesResult>(Routes.guildRoles(...args)),
  ...
  addReaction: (...args: Parameters<typeof Routes.channelMessageOwnReaction>) => rest.put<RESTPutAPIChannelMessageReactionResult>(Routes.channelMessageOwnReaction(...args)),
