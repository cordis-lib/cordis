...
export const makeRestUtils = (rest: RestManager) => (
  {
    ...
    executeSlackWebhook: (webhookID: dAPI.Snowflake, webhookToken: string, options: dAPI.RESTPostAPIWebhookWithTokenSlackQuery) => rest.post<dAPI.RESTPostAPIWebhookWithTokenSlackResult | dAPI.RESTPostAPIWebhookWithTokenSlackWaitResult, null, dAPI.RESTPostAPIWebhookWithTokenSlackQuery>(dAPI.Routes.webhookPlatform(webhookID, webhookToken, 'slack'), { data: null, query: options }),
    executeGithubWebhook: (webhookID: dAPI.Snowflake, webhookToken: string, options: dAPI.RESTPostAPIWebhookWithTokenGitHubQuery) => rest.post<dAPI.RESTPostAPIWebhookWithTokenGitHubResult | dAPI.RESTPostAPIWebhookWithTokenGitHubWaitResult, null, dAPI.RESTPostAPIWebhookWithTokenGitHubQuery>(dAPI.Routes.webhookPlatform(webhookID, webhookToken, 'github'), { data: null, query: options }),
