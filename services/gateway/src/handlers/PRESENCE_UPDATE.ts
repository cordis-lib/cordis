import { GatewayPresenceUpdateData } from 'discord-api-types';
...
const presenceUpdate: Handler<GatewayPresenceUpdateData> = (data, service) => service.publish(data, 'presenceUpdate');
